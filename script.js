...
var gumPromise = navigator.mediaDevices.getUserMedia({ video: { width: MEDIAW, height: MEDIAH }, audio: false }).then(res => {
    asciiGenerator(res); //se envie la media del usuario
});
...
function asciiGenerator(stream) {
